...
- Optional `All-day` task mode (non-fixed): choose consecutive weekdays and render a clean calendar-style multi-day bar across the week (ideal for course/travel)
